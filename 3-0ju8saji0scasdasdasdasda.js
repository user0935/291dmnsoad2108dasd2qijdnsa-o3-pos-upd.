class RedditBehavior {
  ...
  /**
   * The constructor is called by Browsertrix with the context object.
   * We'll set up our instance properties here.
  ...
  constructor(context) {
    ...
    console.log("RedditBehavior initialized for URL:", this.page.url());
  }
   ...
   */
  async run() {
    console.log("Running RedditBehavior...");
